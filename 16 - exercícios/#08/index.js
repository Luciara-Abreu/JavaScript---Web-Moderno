...
que seu melhor e pior desempenho. 
...
Exemplo:String: “10 20 20 8 25 3 0 30 1” Retorno: [3, 7] (Significa que ele 
bateu três vezes seu recorde de melhor pontuação e a pior pontuação
...
function avaliaPontuacoes (stringPontuacoes) {
    ...
    return `
    Quantidade de recorde = ${qtdQuebraDeRecords},    
...
console.table(avaliaPontuacoes(stringPontuacoes))